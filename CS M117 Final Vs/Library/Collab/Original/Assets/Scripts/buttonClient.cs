        ...
        lock (myLock)
        {
            while (data.Count > 0)
            {
                ...
                else
                {
                    ...
                    Debug.Log("option: " + buttonUpdate[0]);
                    Debug.Log("command: " + buttonUpdate[1]);

                    Manager1.commandText.text = myGameBoard.updateGameBoard(buttonUpdate[0], buttonUpdate[1]);
                }
...
class sliderButton : ButtonBase
{
    ...
    {
        { "0", "Set Heave_ho to Baby Min" },
        { "1", "Set Heave_ho to Min" },
        { "2", "Set Heave_ho to Max" },
        { "3", "Set Heave_ho to Super Max" }
    };
